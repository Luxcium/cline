...
[claude-dev](../../../../README.md) / [integrations/terminal/TerminalProcess](../README.md) / TerminalProcess

# Class: TerminalProcess

Defined in: src/integrations/terminal/TerminalProcess.ts:18

## Extends

- `EventEmitter`\<[`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md)\>

## Constructors

### Constructor

> **new TerminalProcess**(`options?`): `TerminalProcess`
...
`EventEmitter<TerminalProcessEvents>.constructor`
...
Defined in: src/integrations/terminal/TerminalProcess.ts:24
...
Defined in: src/integrations/terminal/TerminalProcess.ts:19
...
`K` | keyof TerminalProcessEvents

##### args

...`K` *extends* keyof [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md) ? [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md)\[`K`\<`K`\>\] : `never`
...
keyof TerminalProcessEvents | `K`

##### listener

`K` *extends* keyof [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md) ? [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md)\[`K`\<`K`\>\] *extends* `unknown`[] ? (...`args`) => `void` : `never` : `never`
...
Defined in: src/integrations/terminal/TerminalProcess.ts:251
...
> **eventNames**(): (`"error"` \| `"line"` \| `"continue"` \| `"completed"` \| `"no_shell_integration"`)[]
...
(`"error"` \| `"line"` \| `"continue"` \| `"completed"` \| `"no_shell_integration"`)[]
...
Defined in: src/integrations/terminal/TerminalProcess.ts:258
...
> **listeners**\<`K`\>(`eventName`): `K` *extends* keyof [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md) ? [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md)\[`K`\<`K`\>\] *extends* `unknown`[] ? (...`args`) => `void` : `never` : `never`[]
...
> **rawListeners**\<`K`\>(`eventName`): `K` *extends* keyof [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md) ? [`TerminalProcessEvents`](../interfaces/TerminalProcessEvents.md)\[`K`\<`K`\>\] *extends* `unknown`[] ? (...`args`) => `void` : `never` : `never`[]
...
Defined in: src/integrations/terminal/TerminalProcess.ts:266
...
> **run**(`terminal`, `command`): `Promise`\<`void`\>

Defined in: src/integrations/terminal/TerminalProcess.ts:27
